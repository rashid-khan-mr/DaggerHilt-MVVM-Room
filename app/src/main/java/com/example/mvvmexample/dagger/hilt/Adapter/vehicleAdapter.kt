...
class vehicleAdapter constructor(private val context: Context, private var vehicleList:ArrayList<Vehicle>) : RecyclerView.Adapter<vehicleAdapter.UserViewHolder>(){
