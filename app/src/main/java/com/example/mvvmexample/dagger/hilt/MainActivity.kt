package com.example.mvvmexample.dagger.hilt
...
import com.example.mvvmexample.UserViewModel
import com.example.mvvmexample.Vehicle
import com.example.mvvmexample.vehicleAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun init(){
        ...
        vehicleViewModel.getAllUserData().observe(this, Observer {
    ...
    private fun saveVehicleIntoDatabase() {
        ...
        {
            vehicleViewModel.insert(Vehicle(getName,Integer.parseInt(getPrice)))
